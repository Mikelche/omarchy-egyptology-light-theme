# Egyptology Light - A Light Mode Theme for Omarchy
...
## How to Install
There are two ways to install this theme in [Omarchy](https://omarchy.org/).

### Installing from Omarchy Menu
1. Copy the URL of this repository: `https://github.com/Mikelche/omarchy-egyptology-light-theme`
2. Press `SUPER + ALT + SPACE` to open the Omarchy menu.
3. Select `Install`, then `Style`, then `Theme`.
4. Paste the repository link you copied in the step 1, and press Enter to install.
